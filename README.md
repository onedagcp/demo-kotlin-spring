# Kotlin with Spring Boot 1.5.10 Rest API application
...
```text
java -jar build\libs\demo-kotlin-spring-0.0.1-SNAPSHOT.jar
```

```text
java -jar -Dspring.profiles.active=dev build\libs\demo-kotlin-spring-0.0.1-SNAPSHOT.jar
```
